...
def search(request):
    ...
    return render(request, 'index.html', content_type="text/html", context={'page':page,'price_range':price_range,'full_path': fullPath, 'params': params})
...
def home(request):
    ...
    return render(request, 'index.html', content_type="text/html", context={'page': page,'price_range':price_range,'full_path': '?','params':params})
